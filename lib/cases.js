...
export const CASES = [
  ...
  },
  {
    ...
    commonsFile: "File:Gingivitis-before.JPG",
  ...
  },
  {
    ...
    commonsFile: "File:Stage 3 MRONJ.jpg",
  ...
  },
  {
    ...
    imageLabel: "Foto", imageKey: "gingivitis",
    commonsFile: "File:Gingivitis-before.JPG",
    imageCaption: "Ich hab mal ein Foto gemacht, sehen Sie mal.",
    imageContent: "Ich schicke Ihnen ein Foto. Befund: deutliche Zahnstein- und Plaqueablagerungen am Zahnfleischsaum, das Zahnfleisch ist gerötet und geschwollen.",
  ...
  // ---------------- mittel ----------------
  {
    ...
    imageLabel: "Röntgenbild", imageKey: "pulpitis",
    imageCaption: "Hier ist die Aufnahme von letzter Woche.",
    imageContent: "Ich schicke Ihnen das Röntgenbild. Befund: teilretinierter Weisheitszahn 38 in Mesialkippung, die Schleimhautkapuze bedeckt noch einen Teil der Krone.",
  ...
  },
  {
    ...
    imageLabel: "Foto", imageKey: "pregnancy_gingivitis",
    commonsFile: "File:Gingivitis-before.JPG",
    imageCaption: "Ich habe ein Foto gemacht, weil es so schlimm aussieht.",
    imageContent: "Ich schicke Ihnen ein Foto. Befund: stark gerötete, wulstig geschwollene Interdentalpapillen, deutliche Blutungsneigung, mäßige Plaqueablagerungen.",
