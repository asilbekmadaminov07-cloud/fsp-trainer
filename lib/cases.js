...
export const CASES = [
  ...
  },
  {
    ...
    imageLabel: "Foto", imageKey: "caries_primary",
    commonsFile: "File:Dental Caries Cavity 2 (cropped).JPG",
    imageCaption: "(Die Mutter hält das Handy hin.) Hier, das habe ich zu Hause fotografiert.",
    imageContent: "Die Mutter zeigt ein Foto vom Zahn. Befund: ausgedehnte kariöse Kavität am Milchzahn 54 mit erweichtem, dunkel verfärbtem Dentin, die Läsion reicht tief Richtung Pulpa.",
