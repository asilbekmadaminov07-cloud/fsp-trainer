...
export const FINDINGS = {
  ...
  // RAD ETILDI: klinik foto tishlarning og'ir abraziya/karies bilan yemirilishini ko'rsatadi,
  // tishlar yo'qligi yoki vertikal o'lcham pasayishi aniq ko'rinmaydi — topilmaga mos kelmaydi
  vertikaler_dimensionsverlust: {
    label: 'Verlust der Vertikaldimension bei Zahnverlust',
    file: 'File:Loss of vertical dimension.jpg',
    verified: false,
    rejected: 'Bild zeigt starke Abrasion/Karies, kein eindeutiger Zahnverlust oder Bisshöhenverlust erkennbar',
    befund: '',
    fits: []
  },
  ...
  // ---------- ENDODONTIE / IATROGEN ----------
  // RAD ETILDI: kanalda radiopak plombirovka moddasi (gutta-perka) ko'rinmayapti — topilmaga mos emas
  wurzelfuellung_47: {
    label: 'Wurzelkanalbehandelter Molar',
    file: 'File:Iopa.jpg',
    verified: false,
    rejected: 'kein radiopakes Wurzelfüllmaterial im Kanal sichtbar',
    befund: '',
    fits: []
  },
  frakturiertes_instrument: {
    ...
    verified: true,
    befund: 'wurzelkanalbehandelter Molar mit drei gefüllten Kanälen, im mesialen Kanal ein zusätzliches metallisches Fragment (frakturiertes Instrument) im koronalen Anteil',
    fits: ['Komplikation Wurzelkanalbehandlung', 'Aufklärung', 'Überweisung Endodontologie']
  },
  // RAD ETILDI: sinish chizig'i ko'rinmaydi, aksincha shtift-kuluvka (post-core) restavratsiyasi ko'rinadi;
  // rasmda klinika logotipi ham bor
  wurzelfraktur: {
    label: 'Wurzelfraktur vor Extraktion',
    file: 'File:Solo - breuk.jpg',
    verified: false,
    rejected: 'keine Frakturlinie erkennbar, zeigt Stiftaufbauten statt Wurzelfraktur; zudem Praxislogo im Bild',
    befund: '',
    fits: []
  },
  hemisektion: {
    ...
    verified: true,
    befund: 'Zustand nach Hemisektion eines unteren Molaren, verbleibende einzelne Wurzel mit Aufbau, Nachbarzahn mit regelrechter Furkation zum Vergleich',
  ...
  implantat_regelrecht: {
    ...
    verified: true,
    befund: 'zwei zylindrische Schraubenimplantate im Seitenzahnbereich, regelrechte Osseointegration ohne periimplantäre Aufhellung',
  ...
  wechselgebiss: {
    ...
    verified: true,
    befund: 'Panoramaschichtbild im Wechselgebiss mit Milch- und bleibenden Zähnen nebeneinander, unauffälliger Zahnwechsel',
  ...
  amelogenesis: {
    ...
    verified: true,
    befund: 'deutlich reduzierte Schmelzopazität an mehreren Zähnen, dünner und irregulär begrenzter Schmelzmantel',
    fits: ['Amelogenesis imperfecta', 'Schmelzdefekt', 'genetische Erkrankung']
  },

  // ---------- SONSTIGE ----------
  // RAD ETILDI: rasmda oq strelka topilma joyini ko'rsatib turibdi — javobni oshkor qiladi
  cod: {
    label: 'Zemento-ossäre Dysplasie',
    file: 'File:Periapical COD.png',
    verified: false,
    rejected: 'weißer Pfeil markiert die Läsion im Bild',
    befund: '',
    fits: []
  },
  // RAD ETILDI: rasmda qizil doira topilmani belgilab turibdi — javobni oshkor qiladi
  odontogene_sinusitis: {
    label: 'Odontogene Sinusitis (CT)',
    file: 'File:Odontogenic sinusitis.jpg',
    verified: false,
    rejected: 'roter Kreis markiert die Läsion im Bild',
    befund: '',
    fits: []
  },
  // RAD ETILDI: rasmda "Aufhellung" deb yozib qo'yilgan, ustiga doira va strelka — javobni to'liq oshkor qiladi
  aufhellung_generisch: {
    label: 'Aufhellung auf dem Röntgenfilm',
    file: 'File:Aufhellung.jpg',
    verified: false,
    rejected: 'Bildbeschriftung "Aufhellung" plus Kreis und Pfeil verraten die Antwort',
    befund: '',
    fits: []
  },
  amalgamfuellung: {
    ...
    verified: true,
    befund: 'ausgedehnte Amalgamfüllung in der Zahnkrone, klare Röntgenaufnahme ohne Markierungen',
