...
export const FINDINGS = {
  ...
  normal_opg_senior: {
    label: 'Zahnloser Ober- und Unterkiefer im OPG',
    file: 'File:OPT - Paciente de sexo masculino de 85 años.webp',
    verified: true,
    befund: 'Panoramaschichtaufnahme eines vollständig zahnlosen Ober- und Unterkiefers mit deutlich atrophierten Kieferkämmen; keine verbliebenen Zähne erkennbar',
    fits: ['Totalprothesenplanung', 'Druckstelle unter Totalprothese', 'Kieferkammatrophie', 'Kontrolluntersuchung im Alter']
  },
  ...
  retinierter_eckzahn_opg: {
    label: 'OPG mit retiniertem oberen Eckzahn',
    file: 'File:Orthopantomogram showing impacted upper canine.jpg',
    verified: true,
    befund: 'Panoramaschichtaufnahme mit nicht durchgebrochenem, verlagertem oberen Eckzahn; Lagebeziehung zu den Nachbarwurzeln muss vor Therapie geplant werden',
    fits: ['retinierter Eckzahn', 'persistierender Milcheckzahn', 'Lücke in der Zahnreihe', 'kieferorthopädisch-chirurgische Therapie']
  },
  ...
  fehlende_weisheitszaehne: {
    label: 'OPG ohne Weisheitszahnanlagen',
    file: 'File:Orthopantomogram of missing eight side wisdom teeth in upper and lower arches.jpg',
    verified: true,
    befund: 'Panoramaschichtaufnahme ohne erkennbare Weisheitszahnanlagen in Ober- und Unterkiefer; übrige Zahnreihen sind übersichtlich beurteilbar',
    fits: ['Nichtanlage der Weisheitszähne', 'Zufallsbefund', 'kieferorthopädische Planung', 'unauffällige Verlaufskontrolle']
  },

  // ---------- KIEFERORTHOPÄDIE / ZAHNENTWICKLUNG ----------
  wechselgebiss_opg: {
    label: 'OPG im Wechselgebiss mit gekrümmter Wurzel',
    file: 'File:Orthopantomogram of a mixed dentition patient with curved root.jpg',
    verified: true,
    befund: 'Panoramaschichtaufnahme im Wechselgebiss mit Milchzähnen, bleibenden Zahnkeimen und auffällig gekrümmter Wurzel; kein akuter entzündlicher Befund',
    fits: ['Wechselgebiss', 'Durchbruchsstörung', 'gekrümmte Wurzel', 'kieferorthopädische Beurteilung']
  },
  engstand_mittel: {
    label: 'OPG mit moderatem Engstand',
    file: 'File:Orthopantomogram of moderate crowding.jpg',
    verified: true,
    befund: 'Panoramaschichtaufnahme mit moderatem Platzmangel und überlagerten beziehungsweise gedrehten Frontzähnen; keine akute apikale Läsion',
    fits: ['moderater Engstand', 'erschwerter Zahndurchbruch', 'kieferorthopädischer Behandlungsbedarf', 'Mundhygieneproblem']
  },
  engstand_stark: {
    label: 'OPG mit ausgeprägtem Engstand',
    file: 'File:Orthopantomogram of severe dental crowding.jpg',
    verified: true,
    befund: 'Panoramaschichtaufnahme mit ausgeprägtem Platzmangel, deutlichen Zahnüberlagerungen und gestörter Einordnung mehrerer Zähne',
    fits: ['ausgeprägter Engstand', 'Durchbruchsstörung', 'interdisziplinäre KFO-Planung', 'Extraktionsentscheidung']
  },
  fehlende_untere_schneidezaehne: {
    label: 'OPG mit fehlenden unteren Schneidezähnen',
    file: 'File:Orthopantomogram of a patient with missing lower incisors.jpg',
    verified: true,
    befund: 'Panoramaschichtaufnahme mit fehlenden unteren Schneidezähnen und einer anterioren Lückensituation; weitere Planung erfordert klinische und anamnestische Einordnung',
    fits: ['Nichtanlage', 'Zahnverlust nach Trauma', 'prothetischer Lückenschluss', 'kieferorthopädische Planung']
  },
